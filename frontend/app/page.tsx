  ...
  return (
    <MainLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatCard title="Vendas Hoje" value="R$ 12.450" icon={<TrendingUp className="h-5 w-5" />} />
        ...
        <StatCard title="Produtos em Baixa" value="12" icon={<AlertTriangle className="h-5 w-5" />} />
      </div>
